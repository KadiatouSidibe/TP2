...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener envoyerListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(tValue <= 0)
                makeText(MainActivity.this, "La taille doit être positive", LENGTH_SHORT).show();
            else {
    ...
    private String interpreteIMC(float imc) {
        ...
        if(imc<16.5){
            ...
            chaine="corpulence normal";
        }else if(imc>=25 && imc<30){
            chaine="surpoids";
        }else if(imc>=30 && imc<35){
            chaine="obèsité modérée";
        }else if(imc>=35 && imc<40){
            chaine="obèsité sévère";
        }else{
            chaine="obèsité massive";
        }
